...
public class SimpleChatServerThread extends JFrame implements ActionListener, Runnable {
	...
	public void openServer() throws IOException {
		...
		// 1. 객체생성 => this
		// 2. Thread 와 has a
		if (thread == null) {// Thread가 생성되지 않았을 때만 생성한다.ㅗ
